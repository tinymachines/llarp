#!/bin/bash
# Configuration script for Lazarus Box 3 (Switch-based setup)
# Run this on the cloned image to convert it to Box 3

echo "Configuring Lazarus Box 3 for switch-based setup..."

# Change network configuration for switch setup
uci set network.lan.ipaddr='17.0.0.12'
...
echo "IP: 17.0.0.12 (switch-based)"
